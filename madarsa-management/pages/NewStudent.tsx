...
import { ArrowLeft, Save, ClipboardList, Info, Phone, User, Home, BookOpen, Clock } from 'lucide-react';
import { classSessions, timeSlots } from '../services/mockData';
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex items-center justify-between no-print">
        ...
        <div className="flex gap-3">
          <Button variant="outlined" color="primary" onClick={() => navigate('/students')}>Cancel</Button>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Card className="bg-primary-50/50 dark:bg-primary-900/5 border border-primary-100 dark:border-primary-900/30">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div>
                  ...
                  <select 
                    className="w-full h-10 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                    onChange={e => {
                        // In a real app we'd map this to the student object
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              ...
              />
              <TextField 
                label="Initial Receipt No. (رسید نمبر)" 
        ...
        <div className="flex justify-end gap-4 pb-12">
            <Button variant="outlined" color="primary" size="lg" onClick={() => navigate('/students')}>Discard</Button>
